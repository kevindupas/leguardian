    ...
    */
    ...
    'recorders' => [
        ...
        Recorders\SlowJobs::class => [
            ...
            'threshold' => env('PULSE_SLOW_JOBS_THRESHOLD', 0),
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            'threshold' => env('PULSE_SLOW_OUTGOING_REQUESTS_THRESHOLD', 0),
            'ignore' => [
        ...
        Recorders\SlowQueries::class => [
            ...
            'threshold' => env('PULSE_SLOW_QUERIES_THRESHOLD', 0),
        ...
        Recorders\SlowRequests::class => [
            ...
            'threshold' => env('PULSE_SLOW_REQUESTS_THRESHOLD', 0),
            'ignore' => [
