...
export default function ProfileScreen() {
  ...
  const fetchUser = async () => {
    try {
      ...
      Alert.alert(t('common.error'), 'Impossible de charger les informations utilisateur');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleLogout = async () => {
    Alert.alert(t('profile.logout'), 'Voulez-vous vraiment vous déconnecter ?', [
            ...
            {(['light', 'dark', 'system'] as const).map((mode) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      themeMode === mode ? colors.primary + '20' : 'transparent',
                    borderColor:
